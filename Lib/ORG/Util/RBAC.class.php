...
CREATE TABLE IF NOT EXISTS `think_access` (
  ...
  KEY `groupId` (`role_id`),
  KEY `nodeId` (`node_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='各个操作和用户组的对应表';
...
CREATE TABLE IF NOT EXISTS `think_role_user` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户和用户组对应表';
...
(1,	'admin',	'admin',	'21232f297a57a5a743894a0e4a801fc3',	'',	1406535890,	'127.0.0.1',	1,	NULL,	'',	'',	0,	0,	1,	0,	'');
*/
class RBAC {
    // 认证方法
